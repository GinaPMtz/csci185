function defaultTheme() {
    // your code here.
    console.log('update to show default theme');
    document.querySelector('body').className ='';
}

function oceanTheme() {
   // your code here.
   console.log('update to show ocean theme');
    document.querySelector('body').className ='ocean';
}

function desertTheme() {
   // your code here.
   console.log('update to show desert theme');
   document.querySelector('body').className ='desert';
}

function highContrastTheme() {
    // your code here.
    console.log('update to show high contrast theme');
